            ...
            let html = `
                <li name="${save.items[item].name}" order="${item}">
                    ...
                    <span class="focused" id="focus-${save.items[item].name}">
                        ...
                        <svg style="margin-right: -160px; margin-top: -35px;" onclick="edit();" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
